A dense, atmospheric Sandstorm effect.

Simply load the example Sandstorm.unity scene, or drag the Sandstorm_Particles prefab from the Prefabs folder into the Hierarchy window.
