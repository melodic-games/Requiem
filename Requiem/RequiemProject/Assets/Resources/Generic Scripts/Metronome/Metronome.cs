...
public class Metronome : MonoBehaviour {
    ...
    private float waveform = 0;
    private float waveformPrevious = 0;
    ...
    private void Update()
    {
        ...
        waveformPrevious = waveform;
        waveform = Mathf.Sin((nextTime - Time.time) / interval * 90 * Mathf.Deg2Rad);

        //if (waveformPrevious != waveform)
        //{           
        //    if (targets != null)
        //    {
        //        foreach (GameObject target in targets)
        //        {
        //            target.SendMessage("Waveform", waveform);
        //        }
        //    }
        //}
